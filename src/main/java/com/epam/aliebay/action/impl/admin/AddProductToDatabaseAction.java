...
public class AddProductToDatabaseAction implements Action {
    private static final Logger LOGGER = Logger.getLogger(AddProductToDatabaseAction.class);
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        if (req.getSession().getAttribute(CURRENT_USER_ATTRIBUTE) == null) {
            ...
            if (req.getSession().getAttribute(EDITED_PRODUCT_ATTRIBUTE) == null) {
                ...
                editedProduct = (Product) req.getSession().getAttribute(EDITED_PRODUCT_ATTRIBUTE);
            }
