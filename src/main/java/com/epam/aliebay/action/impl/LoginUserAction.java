...
public class LoginUserAction implements Action {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        if (ValidationUtils.isParameterNullOrEmpty(usernameOrEmail)) {
            req.setAttribute(WRONG_LOGIN_ATTRIBUTE, true);
            areAllParametersValid = false;
        }
        if (ValidationUtils.isParameterNullOrEmpty(password)) {
